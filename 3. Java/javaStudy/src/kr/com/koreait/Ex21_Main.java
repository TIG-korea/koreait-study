...
public class Ex21_Main {
	...
	public static void main(String[] args) {
		...
		// - 자바에서는 단일 상속만 가능 (부모 1개만 가질 수 있음)
		// - 모든 클래스의 최상위 부모 클래스는 Object 클래스를 가짐 
		
		// super()
		// - 부모 클래스의 생성자를 호출
		// - 첫 줄에는 다른 생성자를 호출하는 부분이 없다면 컴파일러가 super()자동 삽입
		// 		> this() 등이 없다면
...
//		Ex21_3_Animal a = new Ex21_3_Animal("흰둥이",8);
//		a.eat();
//		a.sleep();
//	
		Ex21_3_Dog d = new Ex21_3_Dog("황구",4);
		d.wagTail();
		d.eat();
		d.sleep();
		
		Ex21_3_Cat c = new Ex21_3_Cat("나비",2);
		c.nyangPunch();
		c.eat();
		c.sleep();
